...
public class MaxSubArray {
    ...
    public static int maxSubArray(int[] nums) {
        ...
        for (int i=0;i<nums.length;i++){
            ...
            System.out.println("curr and max subarray = " + currSum +" and "+maxSum);
        }
        return maxSum;
    }
