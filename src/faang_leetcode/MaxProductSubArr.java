...
public class MaxProductSubArr {
    //optimal solution-dynamic Programming Time Complexity O(n), Space-O(1)
    public static int maxProductSubArray(int[] nums) {
        ...
        int max=nums[0];
        int ans=max;
        System.out.println("curr = " + nums[0] +" min "+min+" max "+max);
    ...
    public static int maxProductSubArrayBruteForce(int[] nums) {
        System.out.println("nums = " + Arrays.toString(nums));
        int maxProd=nums[0];
        for (int i=0;i<nums.length;i++){
            int curr=1;
            System.out.println("curr 1st loop = " + curr);
            for(int j=i;j<nums.length;j++){
                curr=curr*nums[j];
                System.out.println("curr 2nd loop = " + curr);
